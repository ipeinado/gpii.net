...
rsync -e 'ssh ' -akz --remove-source-files gpiiweb@192.168.123.79:/var/www/clients/client4/web5/tmp/gpiiprod-db.sql /home/bcaldwell/code/gpii.net/backups/gpiiprod-db.sql
...
# # enable modules
# lando drush --yes en reroute_email search_api_override patchinfo
