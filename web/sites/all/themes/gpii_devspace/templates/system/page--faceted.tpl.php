...
<div id="wrap" class="wrapper">
  ...
  <div id="main-container" class="main-container container-fluid faceted-page-container">
    ...
    <div class="row">
      ...
      <?php if (!empty($page['sidebar_first'])): ?>
        <aside id="sidebar_first" class="<?php print $sidebar_first_column_class; ?> facets-sidebar" role="complementary">
          <h2>Refine by</h2>
