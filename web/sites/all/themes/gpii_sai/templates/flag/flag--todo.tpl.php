...
// http://dev.ul.gpii.net/content/flag/flagging/todo/6187/edit
// http://dev.ul.gpii.net/flag/flagging/todo/6187/edit?destination=node/6187
$flag_classes .= ' btn btn-warning';

$link_href = substr($link_href, 0, strpos($link_href, "?destination="));
?>
...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" target="gpii-ul-product-todo" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?>" rel="nofollow"><span class="fa fa-check-square-o"></span> <?php print $link_text; ?></a><span class="flag-throbber">&nbsp;</span>
  <?php else: ?>
