(function($) {
  ...
  $(document).ready(function() {
    ...
    if (url.length === 0 && !$('#edit-search-api-views-fulltext').val()) {
      ...
      $('.view-search.view-display-id-page_2 .st-search .resultcount h2').text('No similar products found').after('<p>Next steps: Select the characteristics (listed below) that you are most interested in.</p>');
    }
